    ...
    <div class="chute chute-center">
      <div class="mw1500 center-block">
        ...
        <div class="allcp-form">
          <div class="panel">
            <div class="panel-heading"><div class="panel-title">Editar Pacote</div></div>
            <div class="panel-body">
              ...
              <?php echo form_open_multipart('Pacote/Atualizar', 'id="form-ui"', array('id'=>$this->pacote_m->getId())); ?>
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="section">
                    <span title="Campo obrigatório" class="help-block">Título<span class="text-danger">*</span></span>
                    <label class="field prepend-icon">
                      <input name="titulo" value="<?php echo $this->pacote_m->getTitulo(); ?>" placeholder="Título do Pacote" maxlength="65" required id="titulo" class="gui-input" autocomplete="off">
                ...
                <div class="col-xs-12 col-sm-3 col-md-3">
                  <div class="section">
                    ...
                    <label class="field prepend-icon">
                      <input type="text" name="dataInclusao" value="<?php echo $this->pacote_m->getDataInclusao();?>" readonly="true" onmousedown="return false;" onmousedown="return false;" onselectstart="return false;" placeholder="Data de Inclusão da Pacote" id="dataInclusao" class="gui-input" autocomplete="off">
                      <label for="dataInclusao" class="field-icon"><i class="fa fa-calendar"></i></label>
                    </label>
                  </div>
                </div>
								<div class="col-xs-12 col-sm-3 col-md-3" id="divAlteracao">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-10 col-md-10">
                  <div class="section" id="section-regulamentos">
                    ...
                    <?php $this->texto_m->desmontarRegulamento($this->pacote_m->getRegulamentos());?>
                    <!-- <label id="label0" class="field prepend-icon" style="margin-bottom: 10px;">
                      <input name="regulamento0" value="<?php //echo $this->pacote_m->getRegulamentos(); ?>" placeholder="Regra do Regulamento" maxlength="512" required id="regulamento0" class="gui-input" autocomplete="off">
              ...
              <div class="col-xs-12 col-sm-7 col-md-7 center-block">
                <span title="Obrigatório" class="help-block">Inclusão de Imagem</span>
								<div class="img-container pv10" style="background: #ffffff;min-height:580px !important">
									...
									if($this->pacote_m->getCaminho() != "" || $this->pacote_m->getCaminho() != null){
										echo base_url('assets/img/pousada_pacote/'.$this->pacote_m->getCaminho().'?dummy='.date("d/m/YH:m:s"));
									}else{
            ...
            <div class="row">
              <div class="col-md-offset-10 col-md-2">
                <button id="enviar" type="submit" class="btn btn-bordered btn-warning mb5 pull-right"><span class="fa fa-plus"></span> Salvar Edição</button>
              </div>
            </div>
            <?php echo form_close(); ?>
          </div>
