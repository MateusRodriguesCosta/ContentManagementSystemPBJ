		...
		<div class="chute chute-center">
			<div class="mw1500 center-block">
				<div class="allcp-form">
					<div class="panel">
						<div class="panel-heading"><div class="panel-title">Novo Usuário</div></div>
						<div class="panel-body">
							...
							<?php echo form_open('Usuario/Inserir', 'id="form-ui"'); ?>
							<div class="row">
								<div class="col-md-4">
									<div class="section">
										<span title="Obrigatório" class="help-block">Nome <span class="text-danger">*</span></span>
										<label class="field prepend-icon">
											<input name="nome" value="<?php echo set_value('nome'); ?>" placeholder="Nome do Usuário" required id="nome" class="gui-input">
								...
								<div class="col-md-5">
									<div class="section">
										...
										<label class="field prepend-icon">
											<input type="email" name="email" value="<?php echo set_value('email'); ?>" placeholder="E-mail do Usuário" required id="email" class="gui-input">
								...
								<div class="col-md-3">
									<div class="section">
										...
										<label class="field prepend-icon">
											<input name="login" value="<?php echo set_value('login'); ?>" placeholder="Login do Usuário" required id="login" class="gui-input">
